...
options = {
	...
	month: 'long',
	day: 'numeric'
}; //format for printing date
var server = app.listen(PORT, () => console.log('running on localhost:', PORT)); //Server running on http://localhost:5000/
app.get('/ledger', (req, res) => {
	...
	if(!req.query.start_date || !req.query.end_date|| !req.query.frequency || !req.query.weekly_rent || !req.query.timezone){
		return res.status(400).send("one or more query strings misssing");
	}
